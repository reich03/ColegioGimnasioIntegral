...
{
$reg = $tra->RegistrarNotas();
exit;
}
elseif(isset($_POST["update"]) and $_POST["update"]=="ok")
{
$reg = $tra->ActualizarNotas();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Notas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="notas">Control</a></li>
<li class="active">Gestión de Notas</li>
</ol>
...
<form class="form" method="post" action="#" name="notas" id="notas">


  <div class="row">
    <div class="col-sm-12">
      <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Notas</h3></div>
 ...
 <?php 
 $periodo = new Login();
 $periodo = $periodo->VerificaPeriodo();
 ?>
...
<div id="muestraestudiantesnotas"></div>
</form>
</div>
