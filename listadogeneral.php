...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Listado General de Estudiantes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Listado General de Estudiantes</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Listado General de Estudiantes</h3>
</div>
...
?>
                         ...
                         <td><?php echo $reg[$i]['pnomest']." ".$reg[$i]['snomest']; ?></td>
                         <td><?php echo $reg[$i]['papeest']." ".$reg[$i]['sapeest']; ?></td>
...
<td><?php echo $status = ( $reg[$i]['statusest'] == 1 ? "<span class='label label-success'><i class='fa fa-check'></i> ACTIVO</span>" : "<span class='label label-warning'><i class='fa fa-times'></i> INACTIVO</span>"); ?></td>
                         <td>
<a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerEstudiante('<?php echo base64_encode($reg[$i]["codest"]); ?>')"><i class="fa fa-eye"></i></a>
 </td>
                         </tr>
                         <?php } } ?>
                         </tbody>
