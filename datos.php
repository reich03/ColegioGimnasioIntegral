...
<form class="form" name="updatedocentesession" id="updatedocentesession" method="post" data-id="<?php echo $reg[0]["coddoc"] ?>" action="#">
        ...
        <label class="control-label">Nº de NIT/CI: <span class="symbol required"></span></label> 
<input type="hidden" name="coddoc" id="coddoc" <?php if (isset($reg[0]['coddoc'])) { ?> value="<?php echo $reg[0]['coddoc']; ?>"<?php } ?>>
 <input name="ceddoc" class="form-control" type="text" id="ceddoc" onKeyUp="this.value=this.value.toUpperCase();" <?php if (isset($reg[0]['ceddoc'])) { ?> value="<?php echo $reg[0]['ceddoc']; ?>"<?php } ?> placeholder="Ingrese Nº de NIT/CI de Docente" autocomplete="off" required="required"/>
