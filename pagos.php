...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
             <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos del Pagos</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestrapagosmodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Pagos</h4>
...
<div class="clearfix"></div>
 ...
 <form class="form" method="post" action="#" name="controlpagos" id="controlpagos">

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Pagos</h3></div>
<div class="panel-body">
<div class="row">
...
<option value="<?php echo $per[$i]['codperiodo'] ?>"><?php echo $per[$i]['periodo'] ?></option>			  
            ...
            <div class="modal-footer">
<button type="button" onClick="BuscarPagosxEstudiantes(document.getElementById('codest').value,document.getElementById('codperiodo').value)" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
		    </div>
	     ...
	     <div id="muestrapagosxestudiantes"></div>
		 </form>
</div>
