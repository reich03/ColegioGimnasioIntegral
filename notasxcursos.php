...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Búsqueda de Notas por Cursos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="notas">Control</a></li>
<li class="active">Búsqueda de Notas por Cursos</li>
</ol>
...
<form class="form" method="post" action="#" name="notasxcursos" id="notasxcursos">


<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Notas por Cursos</h3></div>
...
<button type="button" onClick="BuscarNotasxCursos(document.getElementById('codturno').value,document.getElementById('codnivel').value,document.getElementById('codgrado').value,document.getElementById('codseccion').value)" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
        </div>
	     ...
	     <div id="muestranotasxcursos"></div>
		 </form>
</div>
