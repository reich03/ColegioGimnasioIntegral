...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Búsqueda de Pagos al Día</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Búsqueda de Pagos al Dia</li>
</ol>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Pagos al Día</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12">
            <div class="box-body">
 <form class="form" method="post" action="#" name="pagosaldia" id="pagosaldia">
...
<select name="codseccion" id="codseccion" class="form-control">
                              <option value="">SIN RESULTADOS</option>
								...
								<div class="col-md-4"> 
                              <div class="form-group has-feedback"> 
     <label class="control-label">Mes Actual: <span class="symbol required"></span></label> 
  <i class="fa fa-bars form-control-feedback"></i>
 <select name="mespago" id="mespago" class="form-control" required="required">
  <option value="">SELECCIONE</option>
...
<button type="button" onClick="BuscarPagosAlDia(document.getElementById('codturno').value,document.getElementById('codnivel').value,document.getElementById('codgrado').value,document.getElementById('codseccion').value,document.getElementById('mespago').value,document.getElementById('codperiodo').value)" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
		    </div>
